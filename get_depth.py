...
from demo_yolo.srv import GetDepthComand,GetDepthComandResponse
from cv_bridge import CvBridge
from demo_yolo.msg import d_x_y
...
class GetDepth(object):
    def __init__(self):
        ...
        self.get_depth_ser = rospy.Service("/vision/get_depth",GetDepthComand,self.get_depth)
        self.position = None
        self.ans = []
    ...
    def get_depth(self,data):
        pub = rospy.Publisher('dxy',d_x_y,queue_size=10)
